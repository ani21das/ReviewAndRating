...
namespace ReviewAndRating.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ReviewAndRatingConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ReviewAndRatingDbContext context)
        {
            _context = context;
        }
