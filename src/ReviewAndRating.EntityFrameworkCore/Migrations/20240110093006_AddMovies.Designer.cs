...
namespace ReviewAndRating.Migrations
{
    ...
    [Migration("20240110093006_AddMovies")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReviewAndRating.Models.Movies.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ReviewAndRating.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ReviewAndRating.Authorization.Users.User", null)
                        .WithMany("Claims")
