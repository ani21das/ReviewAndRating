...
using ReviewAndRating.Models.TokenAuth;
...
{
    public abstract class ReviewAndRatingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ReviewAndRatingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReviewAndRatingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ReviewAndRatingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ReviewAndRatingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ReviewAndRatingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ReviewAndRatingDbContext, Task<T>> func)
        {
            T result;
